...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// si for verdadeiro imprimi o que estar no if (cod2)si não o que estar no else .
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
  ...
  // si for verdadeiro imprimi o que estar no if (cod4) si não o que estar no else .
	if (cod4 == true)
	{
		cout << "	       | |                     |||||" << endl;
		cout << "	       | |                     |||||" << endl;
	...
	// si for verdadeiro imprimi o que estar no if (cod1) si não o que estar no else .
	else
	{
		cout << "|   |	|\\:\\ \\/__/|\\:\\/:/  /|\\:\\/:/  /|\\:\\:\\/  /|	" << endl;
		cout << "|___|   | \\:\\__\\  | \\::/  / | \\::/  / | \\:\\/  / |	" << endl;
	...
	// si for verdadeiro imprimi o que estar no if si não o que estar no else .
	else
	{
		cout << "                        |   |___| |				" << endl;
		cout << "                        |___|_____|				" << endl;
